...
<div>如果你觉得我们Alloyteam团队的博客和开源项目给你带来价值，可以通过捐赏支持我们  
有你的支持，我们会做得更好！</div>
...
<div class="bshare-custom icon-medium-plus">[分享到:](http://www.bShare.cn/ "分享到:")<a title="分享到QQ空间" class="bshare-qzone"></a><a title="分享到微信" class="bshare-weixin"></a><a title="分享到腾讯微博" class="bshare-qqmb"></a><a title="分享到新浪微博" class="bshare-sinaminiblog"></a><a title="更多平台" class="bshare-more bshare-more-icon more-style-addthis"></a><span class="BSHARE_COUNT bshare-share-count">0</span></div>

</div>

<div id="comments" class="comments"><script type="text/javascript">var defaultAuthor = "称呼(必填)"; var defaultEmail = "邮箱(不会被公开,必填)"; var defaultUrl = "网站"; var defaultComment = "评论内容..."; function commentform_submit(){ if(document.commentform.author.value == '' || document.commentform.author.value == defaultAuthor) {alert('咳咳...称呼忘填了');document.commentform.author.focus();return;} if(document.commentform.email.value == '' || document.commentform.email.value == defaultEmail) {alert('email...您的email没填');document.commentform.email.focus();return;} if(document.commentform.comment.value == '' || document.commentform.comment.value == defaultComment) {alert('评论内容在哪？');document.commentform.comment.focus();return;} if(document.commentform.url.value == defaultUrl) document.commentform.url.value = ''; // document.commentform.submit(); }</script>

<div id="respond" class="commentform">

### 发表评论

<div class="cancel-comment-reply">[点击这里取消回复。](/2017/09/13139/#respond)</div>

<form action="http://www.alloyteam.com/wp-comments-post.php" method="post" id="commentform">

<input type="text" name="author" id="author" value="" size="22" tabindex="1"> <label for="author"><small>称呼 (必填)</small></label>

<input type="text" name="email" id="email" value="" size="22" tabindex="2"> <label for="email"><small>邮箱 (不会被公开,必填)</small></label>

<input type="text" name="url" id="url" value="" size="22" tabindex="3"> <label for="url"><small>网站</small></label>
...
<input name="submit" type="submit" id="submit" tabindex="5" value="提 交"><input type="hidden" name="comment_post_ID" value="13139" id="comment_post_ID"> <input type="hidden" name="comment_parent" id="comment_parent" value="0">

<input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="1187f52308">

<input type="hidden" id="ak_js" name="ak_js" value="121">
...
<div class="textwidget"><style type="text/css">.helpus{ display:none; margin: 20px auto; text-decoration:none; color:white; font-size:12px; line-height:1.8; background: url(/wp-content/uploads/2017/03/paybutton2.png) no-repeat center #fff; background-size:cover; width: 219px; height: 80px; border:1px solid rgba(0,0,0,0); border-radius: 10px; } .helpus:hover{ border-radius: 10px 10px 0 0; color:white; } .helpus .paycode{ display:none; position:relative; z-index:100; margin: 80px 0 0 0px; padding:10px; width:200px; background:#cd533d; overflow:hidden; } .helpus:hover .paycode{ display:block; } .helpus .paycode img{ width:200px; }</style>[

<div class="paycode">

<div>　　如果你觉得我们Alloyteam团队的博客和开源项目给你带来价值，可以通过捐赏支持我们，有你的支持，我们会做得更好！</div>

![](/wp-content/uploads/2017/03/wechatpaycode.png)  

![](/wp-content/uploads/2017/03/alipaycode.png)</div>

](javascript:; "支持原创文章 & 开源项目，请我们喝杯咖啡吧^_Q")</div>

</div>

<div class="widget">

<div class="textwidget">[![](http://www.alloyteam.com/wp-content/uploads/2017/05/Group1.png)![](http://cdn.alloyteam.com/assets/img/hot-32d141.png)](http://tfc.qq.com "了解腾讯前端大会")</div>
...
color: #FF9D20;
margin: 0;
font-family: 'Segoe UI Light','Segoe UI','Microsoft Jhenghei','微软雅黑',sans-serif;"><span style="color: #3C92FF;">Code</span>Tank</div>
...
](http://codetank.alloyteam.com/ "点击跳转到CodeTank")</div>

</div>

<div class="widget">

<div class="textwidget">[![](http://www.alloyteam.com/wp-content/uploads/2017/04/01322.jpg)
...
](http://www.alloyteam.com/alloyshare/weekly/p/latest "点击查阅Alloy周刊")</div>
...
<div style="position:absolute;top:0;left:0;width:50%;">![公众号：AlloyTeam](http://www.alloyteam.com/wp-content/uploads/2017/01/weixin.png "公众号：AlloyTeam")
...
<div style="display:block;position:absolute;top:0;right:0;width:50%;">[![QQ公众群：162225981](http://www.alloyteam.com/wp-content/uploads/2017/01/qun.png "QQ公众群：162225981")](http://shang.qq.com/wpa/qunwpa?idkey=6ae26f614ccf38b5495b20e80714a45b97e3146b0e61754b42f91a64bf7526f5)

<div>扫码或点击加入QQ  
[公众群:162225981](http://shang.qq.com/wpa/qunwpa?idkey=6ae26f614ccf38b5495b20e80714a45b97e3146b0e61754b42f91a64bf7526f5)</div>
...
<div class="ilovertitle"><span class="ilovertitlespan">分类目录</span></div>

*   [Alloy 实验室](http://www.alloyteam.com/alloylabs/ "腾讯 Web 前端 Alloy Labs 实验室") (42)
    *   [HTML5游戏](http://www.alloyteam.com/alloylabs/html5game/ "开发HTML5游戏
        ") (14)
    *   [作品](http://www.alloyteam.com/alloylabs/showcase/) (32)
*   [Web开发](http://www.alloyteam.com/webdevelop/ "Web前端开发技术") (486)
    *   [CSS3](http://www.alloyteam.com/webdevelop/css3/) (32)
    *   [HTML5](http://www.alloyteam.com/webdevelop/html5/) (60)
    *   [JavaScript](http://www.alloyteam.com/webdevelop/javascript/) (96)
    *   [Node.js](http://www.alloyteam.com/webdevelop/node/ "Node.js相关的文章") (23)
    *   [Web 前端优化](http://www.alloyteam.com/webdevelop/web-%e5%89%8d%e7%ab%af%e4%bc%98%e5%8c%96/) (32)
    *   [Web 前端资讯](http://www.alloyteam.com/webdevelop/web-%e5%89%8d%e7%ab%af%e8%b5%84%e8%ae%af/) (48)
    *   [用户体验设计](http://www.alloyteam.com/webdevelop/ued/ "用户体验设计、可用性研究、以用户为中心的设计") (18)
    *   [经验心得](http://www.alloyteam.com/webdevelop/%e7%bb%8f%e9%aa%8c%e5%bf%83%e5%be%97/) (13)
*   [团队](http://www.alloyteam.com/team/) (30)
*   [移动开发](http://www.alloyteam.com/mobiledevelop/) (25)
    *   [Android 开发](http://www.alloyteam.com/mobiledevelop/android/ "Android 开发技术") (8)
    *   [iOS 开发](http://www.alloyteam.com/mobiledevelop/ios-develop/ "iOS 开发技术") (1)
    *   [移动 Web 开发](http://www.alloyteam.com/mobiledevelop/mobileweb/ "移动 Web 开发技术") (13)
*   [资源工具](http://www.alloyteam.com/%e8%b5%84%e6%ba%90%e5%b7%a5%e5%85%b7/) (49)

</div>

<div class="widget">

<div class="ilovertitle"><span class="ilovertitlespan">最新文章</span></div>

*   <span class="comment-author-link">lizlalala</span>发表在《[2017·腾讯AlloyTeam招聘·Web+工程师](http://www.alloyteam.com/2015/08/2015-teng-xun-alloyteam-zhao-pin-web-qian-duan-gong-cheng-shi/comment-page-3/#comment-257925)》
*   <span class="comment-author-link">[石樱灯笼](https://www.catscarlet.com)</span>发表在《[gif的故事：解剖表情动图的构成](http://www.alloyteam.com/2017/09/13121/comment-page-1/#comment-257901)》
*   <span class="comment-author-link">Nicholas</span>发表在《[现代化富文本编辑器Quill Editor](http://www.alloyteam.com/2017/09/13191/comment-page-1/#comment-257900)》
*   <span class="comment-author-link">山茶树和葡萄树</span>发表在《[总结伪类与伪元素](http://www.alloyteam.com/2016/05/summary-of-pseudo-classes-and-pseudo-elements/comment-page-1/#comment-257898)》
*   <span class="comment-author-link">xcatliu</span>发表在《[AlloyTeam ESLint 配置指南](http://www.alloyteam.com/2017/08/13065/comment-page-1/#comment-257876)》
*   <span class="comment-author-link">fiture</span>发表在《[AlloyTeam ESLint 配置指南](http://www.alloyteam.com/2017/08/13065/comment-page-1/#comment-257874)》
*   <span class="comment-author-link">[小五仁](http://zengxiaoluan.com/)</span>发表在《[使用Parallax.js实现简单视差效果](http://www.alloyteam.com/2015/09/use-parallax-js-to-implement-simple-parallax-effect/comment-page-1/#comment-257862)》
*   <span class="comment-author-link">emptyx</span>发表在《[Omi应用md2site-0.5.0发布-支持动态markdown拉取解析](http://www.alloyteam.com/2017/03/omi-md2site-0-5-0-released-supports-dynamic-markdown-pull-parsing/comment-page-1/#comment-257834)》
*   <span class="comment-author-link">[阿伟](http://aweig.com)</span>发表在《[现代化富文本编辑器Quill Editor](http://www.alloyteam.com/2017/09/13191/comment-page-1/#comment-257831)》
*   <span class="comment-author-link">leslie</span>发表在《[深拷贝与浅拷贝的实现（一）](http://www.alloyteam.com/2017/08/12978/comment-page-1/#comment-257799)》

</div>

<div class="widget">

<div class="ilovertitle"><span class="ilovertitlespan">合作伙伴</span></div>

<div class="textwidget">[![HTML5梦工场](http://www.alloyteam.com/wp-content/uploads/2017/01/h5dreamworks40.png "HTML5梦工场") HTML5梦工场](http://www.html5dw.com)</div>

</div>

<div class="widget">

<div class="textwidget">[![腾讯云](http://www.alloyteam.com/wp-content/uploads/2015/07/logo-e1485056491948.png "托管于腾讯云") ](http://www.qcloud.com/redirect.php?redirect=1001&cps_key=50b46969b6fa53f1334070ccf5a941d0) [推荐使用腾讯云](http://www.qcloud.com/redirect.php?redirect=1001&cps_key=50b46969b6fa53f1334070ccf5a941d0)</div>

</div>

<div class="widget">

<div class="textwidget">[![Coding](http://www.alloyteam.com/wp-content/uploads/2016/09/codnig.jpg "将代码托管于Coding")推荐使用 Coding.net](https://coding.net/)</div>

</div>

<div class="widget">

<div class="ilovertitle"><span class="ilovertitlespan">兄弟团队</span></div>

*   [腾讯 CDC](http://cdc.tencent.com)
*   [腾讯 ISUX](http://isux.tencent.com/)
*   [腾讯游戏 TGideas](http://tgideas.qq.com/)
*   [腾讯 FERD](http://qqfe.org)
*   [百度前端 EFE](http://efe.baidu.com)
*   [百度前端 FEX](http://fex.baidu.com/)
*   [淘宝前端团队 FED](http://taobaofed.org/)
*   [腾讯 MelonTeam](http://MelonTeam.com)

</div>

<div class="widget">

<div class="ilovertitle"><span class="ilovertitlespan">友情链接</span></div>

*   [印记中文](https://docschina.org "http://www.alloyteam.com/wp-content/uploads/2017/08/印记中文logo-white.png")
*   [iWeb学院](http://www.iwebxy.com/?type=alloyteam)
*   [W3CTech](http://www.w3ctech.com/)
*   [前端观察](http://www.qianduan.net/)
*   [W3C Plus](http://www.w3cplus.com/)
*   [Web 前端开发](http://www.css88.com)
*   [V2EX](http://www.v2ex.com/ "V2EX – 创意工作者们的社区")
*   [腾讯大讲堂](http://djt.qq.com)
*   [蓝色理想](http://www.blueidea.com/)
*   [HTML5中文学习网](http://www.html5cn.com.cn)
*   [爱思资源网](http://www.aseoe.com/)
*   [牛大拿_前端设计导航](http://www.niudana.com)
*   [吕小鸣前端博客](http://www.nihaoshijie.com.cn)
...
<span>Copyright ©  2011-2017 [AlloyTeam](http://www.alloyteam.com). All Rights Reserved. Powered By [WordPress](http://wordpress.org/).</span>

</div>

</div>

<script type="text/javascript">window.onerror=function(){return true;} var alloyrefer = document.referrer; var hasClassListProperty = document && Object.prototype.hasOwnProperty.call(document.documentElement,'classList'); var addClass = function(){ if (hasClassListProperty) { return function (el, className) { if (!el || !className ) { return; } el.classList.add(className); }; } else { return function (el, className) { if (!el || !className ) { return; } el.className += ' ' + className; }; } }(); var refername = "www.alloyteam.com"; var flag = alloyrefer.indexOf(refername) === -1; if(flag && alloyrefer !== ""){ var main = document.getElementById("main"); var alloyteam = document.getElementById("alloyteam"); var alloyteam2 = document.getElementById("alloyteam2"); var tencentInfo = document.getElementById("tencentInfo"); var header = document.getElementById("header"); var alloy = document.getElementById("alloy"); addClass(alloy,'alloy'); addClass(header,'header'); addClass(main,'main'); addClass(alloyteam,'alloyteam'); addClass(alloyteam2,'alloyteam'); addClass(tencentInfo,'tencentInfo'); } document.body.style.display = "block"; if(flag){ setTimeout(function(){ if (navigator.userAgent.indexOf('Firefox') >= 0){ document.documentElement.scrollTop = 1; document.documentElement.scrollTop = 0; }else{ document.body.scrollTop = 2; document.body.scrollTop = 0; } },3000); }</script>

<div align="center"><small>Site is using the [Seo Wizard](https://wordpress.org/plugins/seo-wizard/ "Wordpress Seo") plugin by [http://seo.uk.net/](http://seo.uk.net/)</small></div>

<script type="text/javascript">/* <![CDATA[ */ var ajax_object = {"ajax_url":"http:\/\/www.alloyteam.com\/wp-admin\/admin-ajax.php"}; /* ]]> */</script> <script type="text/javascript">/* <![CDATA[ */ var viewsCacheL10n = {"admin_ajax_url":"http:\/\/www.alloyteam.com\/wp-admin\/admin-ajax.php","post_id":"13139"}; /* ]]> */</script> <script type="text/javascript">/* <![CDATA[ */ var mv_dynamic_to_top = {"text":"To Top","version":"0","min":"300","speed":"300","easing":"easeInOutExpo","margin":"20"}; /* ]]> */</script></div>
